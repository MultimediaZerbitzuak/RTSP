...
public class Client_V1{
  ...
  JTextField hostname=new JTextField("192.168.40.81");
  JLabel portLabel = new JLabel("Port");
  JTextField portnb=new JTextField("2000");
  JLabel vLabel = new JLabel("Video File");
  ...
  static int RTSPSeqNb = 0; //Sequence number of RTSP messages within session
...
// add hostname textbox and label
    ...
    // Tool Tip text
    statPanel.setToolTipText("Streaming Statistics: video bandwidth streaming "
            + "usage: average and peak");
    portnb.setToolTipText("Enter Server port number");
    hostname.setToolTipText("Enter Server address: Ip address XXX.XXX.XXX.XXX "
            + "or server name (ex: healy.ece.orst.edu)");
    vfile.setToolTipText("Enter MJPEG file name");
    portLabel.setToolTipText("Enter Server port number");
    hostLabel.setToolTipText("Enter Server address: Ip address XXX.XXX.XXX.XXX "
            + "or server name (ex: healy.ece.orst.edu)");
   ...
   //---------------------------------------------------------------------------
    ...
    f.setSize(new Dimension(460,500));
    f.setVisible(true);
  ...
  public static void main(String argv[]) throws Exception
  {
    ...
    int RTSP_server_port = Integer.parseInt(theClient.portnb.getText());
    ...
    //init RTSP state:
    state = INIT;
    theClient.mainPanel.setToolTipText("Connection successful, "
  ...
  //get the sequence number with the given method
  int seqNum = rtp_packet.getSequenceNumber();

  //get the timestamp for this packet with the given method
  int timestamp = rtp_packet.getTimeStamp();

  //get the payload type for this packet with the given method
  ...
  System.out.println("Size: " + payload_length );
  System.out.println("Sequence Number: " + seqNum);
  System.out.println("Packet timestamp: " + timestamp + "ms");
  ...
  private void send_RTSP_request(String request_type)
  {
    try{
      ...
      //case write the Transport: line advertising to the server 
