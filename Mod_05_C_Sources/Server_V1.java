...
public class Server_V1 extends JFrame implements ActionListener {
  ...
  int RTP_dest_port = 0; //destination port for RTP packets 
                         //(given by the RTSP Client)
  ...
  public static void main(String argv[]) throws Exception
  {
    ...
    Server_V1 theServer = new Server_V1();
  ...
  public void actionPerformed(ActionEvent e) {
	...
	try {
	  ...
	  RTPpacket rtp_packet = new RTPpacket(
                 MJPEG_TYPE, imagenb, imagenb*FRAME_PERIOD, buf, image_length);
  ...
  System.out.println("Size: " + image_length );
